...
export const TOOLS: ToolManifest[] = [
  ...
  /* ————— حسابات وأعمال ————— */
  {
    ...
    descriptionAr: "إضافةً واستخراجاً، بنسبِ البلدان جاهزةً أو نسبةٍ تختارها.",
    category: "business", icon: "receipt", version: "1.0.0",
    load: () => import("@/tools/vat/tool"),
  },
  {
    slug: "percentage",
    nameAr: "النسبة المئويّة",
    descriptionAr: "ستُّ صيغٍ للسؤال في شاشةٍ واحدة — من الجزء إلى نسبة التغيّر.",
    category: "business", icon: "percent", version: "1.0.0",
    load: () => import("@/tools/percentage/tool"),
  },
  {
    slug: "pricing",
    nameAr: "التسعير والهامش",
    descriptionAr: "من التكلفة إلى سعر البيع — ويفرّق بين الهامش والترميز.",
    category: "business", icon: "tag", version: "1.0.0",
    load: () => import("@/tools/pricing/tool"),
  },
  {
    slug: "discounts",
    nameAr: "الخصومات المتتالية",
    descriptionAr: "خصمٌ على خصمٍ — والنسبةُ الفعليّة التي لا تُجمع.",
    category: "business", icon: "scissors", version: "1.0.0",
    load: () => import("@/tools/discounts/tool"),
  },
  {
    slug: "timesheet",
    nameAr: "ساعات العمل والأجر",
    descriptionAr: "ورديّاتٌ تُجمع ساعاتُها — وتفهم العابرةَ منتصفَ الليل.",
    category: "business", icon: "clock", version: "1.0.0",
    load: () => import("@/tools/timesheet/tool"),
  },
  {
    slug: "split-bill",
    nameAr: "تقسيم فاتورة",
    descriptionAr: "بين أشخاصٍ مع إكراميّة — حصّةُ كلٍّ بالضبط.",
    category: "business", icon: "users", version: "1.0.0",
    load: () => import("@/tools/split-bill/tool"),
  },
  {
    slug: "iban",
    nameAr: "مدقّق IBAN",
    descriptionAr: "تحقّقٌ محلّيٌّ بمعيار mod-97 قبل أن تُرسل حوالةً إلى رقمٍ خاطئ.",
    category: "business", icon: "bank", version: "1.0.0",
    load: () => import("@/tools/iban/tool"),
  },
  {
    slug: "loan",
    nameAr: "جدول سداد قرض",
    descriptionAr: "القسطُ الشهريّ وجدولُ الأصل والفائدة شهراً شهراً.",
    category: "business", icon: "loan", version: "1.0.0",
    load: () => import("@/tools/loan/tool"),
  },
  {
    slug: "zakat",
    nameAr: "حاسبة الزكاة",
    descriptionAr: "نقدٌ وذهبٌ وفضّةٌ وعروضُ تجارة، بنصابِ الذهب أو الفضّة.",
    category: "business", icon: "crescent", version: "1.0.0",
    load: () => import("@/tools/zakat/tool"),
  },
  {
    slug: "end-of-service",
    nameAr: "مكافأة نهاية الخدمة",
    descriptionAr: "تقديرٌ إرشاديٌّ بأنظمة السعوديّة والإمارات أو صيغةٍ تحدّدها.",
    category: "business", icon: "award", version: "1.0.0",
    load: () => import("@/tools/end-of-service/tool"),
  },
  {
    slug: "invoice",
    nameAr: "فاتورة للطباعة",
    descriptionAr: "نموذجٌ عربيٌّ يُملأ ويُطبع أو يُحفظ PDF من المتصفّح.",
    category: "business", icon: "receipt", version: "1.0.0",
